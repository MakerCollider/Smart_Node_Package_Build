...
void cbFunc0(unsigned long arg0) {
    HandleScope scope;
...
void cbFunc1(unsigned long arg0) {
    HandleScope scope;
    const unsigned argc = 1;
    Local<Value> argv[argc];
...
void cbFunc3(unsigned long arg0) {
    HandleScope scope;
    const unsigned argc = 1;
    Local<Value> argv[argc];
...
void cbFunc4(int arg0, unsigned long arg1) {
    HandleScope scope;
    const unsigned argc = 2;
    Local<Value> argv[argc];

    argv[0] = Int32::New(arg0);
        argv[1] = Number::New(arg1);
